...
import com.was.mestrado.cisternas.R;
/**
...
public class DrawableUtil {
    ...
    public static Bitmap getMarkerView(Activity activity, String value, int imageResourceId){
        ...
        //View marke = ((LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.ecopo);
        TextView numTxt = (TextView) marker.findViewById(R.id.marker_number);
       // TextView numTxt = (TextView) marker.findViewById();
